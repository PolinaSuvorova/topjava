    ...
    <div class="container">
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${requestScope.users}" var="user">
                ...
                <tr id="${user.id}" row-user-enable="${user.enabled}" >
                    <td><c:out value="${user.name}"/></td>
                    <td><a href="mailto:${user.email}">${user.email}</a></td>
                    <td>${user.roles}</td>
                    <td><input type="checkbox" <c:if test="${user.enabled}">checked</c:if> id="${user.id}"
                               onclick="enabled($(this),${user.id},<c:if test="${user.enabled}">checked</c:if>)"/></td>
